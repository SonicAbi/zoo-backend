...
class AnimalModel {
  ...
  static async addAnimal({ feedingcost, name, gender, birthDate, species }) {
    const query = {
      name: "post-animal",
...
// src/routes/animalRouter.ts
var animalRouter = new Hono2;
...
class EnclosureModel {
  ...
  static async addEnclosure({ cost, name, size }) {
    const query = {
      name: "add-enclosure",
